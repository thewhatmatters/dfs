...
TEAMS: dict[str, TeamRef] = {
    ...
    for r in (
        ...
        _t("COLO", "Colorado", "Colorado Buffaloes"),
        ...
        _t("MIZZ", "Missouri", "Missouri Tigers"),
        ...
        _t("SCAR", "South Carolina", "South Carolina Gamecocks"),
        _t("SYR", "Syracuse", "Syracuse Orange"),
        _t("TCU", "TCU", "TCU Horned Frogs"),
        ...
        _t("UF", "Florida", "Florida Gators"),
        _t("UGA", "Georgia", "Georgia Bulldogs"),
        _t("UK", "Kentucky", "Kentucky Wildcats"),
        _t("USC", "USC", "USC Trojans"),
        _t("UTAH", "Utah", "Utah Utes"),
        ...
        _t("WVU", "West Virginia", "West Virginia Mountaineers"),
    )
}
