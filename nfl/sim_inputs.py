...
def team_stat_from_row(row: dict) -> TeamStat | None:
    ...
    return TeamStat(
        ...
        pass_n=_int(_pick(row, "pass_n")),
        rush_n=_int(_pick(row, "rush_n")),
        pass_epa_sum=_float(_pick(row, "pass_epa_sum")),
        pass_epa_sq_sum=_float(_pick(row, "pass_epa_sq_sum")),
        rush_epa_sum=_float(_pick(row, "rush_epa_sum")),
        rush_epa_sq_sum=_float(_pick(row, "rush_epa_sq_sum")),
