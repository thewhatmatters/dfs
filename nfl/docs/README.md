...
Choke catalog: [`data/sources.md`](data/sources.md). Player props (Gangstash): [`data/player-props.md`](data/player-props.md). Lineups WR/TE usage tilt: [`data/targets.md`](data/targets.md). Upload CSVs: `nfl/export/`. Hindsight LineStar perfect: [`../data/perfect/`](../data/perfect/) (week-1 12-gamer `133104.json`; not 133647).
