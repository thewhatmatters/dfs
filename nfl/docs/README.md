...
Choke catalog: [`data/sources.md`](data/sources.md). Player props (Gangstash): [`data/player-props.md`](data/player-props.md). Layered Monte Carlo: [`data/sim.md`](data/sim.md). Lineups WR/TE usage tilt: [`data/targets.md`](data/targets.md). Nightly projections publish: [`data/projections.md`](data/projections.md). Upload CSVs: `nfl/export/` when `--export` or `--upload` is set. Hindsight LineStar perfect: [`../data/perfect/`](../data/perfect/) (week-1 12-gamer `133104.json`; not 133647).
