...
Optimizer: `python3 -m nfl.optimize` (contest 133104). Slate coverage: `python3 -m nfl.status` / `--slate-status` (cash-relevant salary bands; see `docs/data/sources.md`). Do not import `ncaaf`. Do not copy `ncaaf/docs/`. “Let’s optimize” stays NCAAF.
